...
Please follow the tutorial [Creating a Game](create_game.md). In particular, the following steps might be of interest:

* Step 6: [How to Run Games Locally](running_locally.md)
* Step 8: [How to Update an existing Game](update_game.md)
* Step 10: [How to Publish a Game](publish_game.md)
...
- [Creating a Game](create_game.md): **the main document to consult**.
- [More about Hints](hints.md): describes the `Hint` and `Branch` tactic.

### Frontend API

* [How to Run Games Locally](running_locally.md): play a game on your computer
* [How to Update an existing Game](update_game.md): update to a new lean version
* [How to Publish a Game](publish_game.md): load your game to adam.math.hhu.de for others to play

### Backend

not fully written yet.

* [Server](DOCUMENTATION.md): describes the server part (i.e. the content of `server/` und `relay/`).
...
For translating games, see [Translating a game](translate.md).
